...
// Funnel-meaningful events only. Internal state changes (checkout_intent,
// checkout_requires_auth, checkout_created) and noise events (home_nav_clicked,
// auth_modal_opened, sidebar_upgrade_clicked) were dropped — sidebar is now
// a `source` value on upgrade_clicked instead of its own event.
export const TRACKED_EVENTS = new Set([
  'page_view',
  'home_begin_clicked',
  'home_pricing_clicked',
  'home_chat_sent',
  'home_chat_handoff_clicked',
  'chat_gate_seen',
  'chat_gate_entered',
  'chat_started',
  'third_message_sent',
